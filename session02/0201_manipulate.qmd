...
### Count the observations of groups with `count()`
...
qog_subset |> slice_max(wdi_co2, n = 5) # Get the n max results of a variable
qog_subset |> slice_min(wdi_co2, n = 3) # Get the n min results of a variable
